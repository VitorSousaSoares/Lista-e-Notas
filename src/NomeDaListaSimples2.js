...
export default function App(props) {
    ...
    const Nomear = async ()=> {
        if (Nome ==="") {
            ...
            props.setNomeListaSimples(Nome);
            
            try{
                const salvarNome = JSON.stringify(Nome)
                await AsyncStorage.setItem('@NomeListaSimples2',salvarNome)
                
            }catch(e){
                
            }
            props.setPagina("ListaSimples2")
        }
    }
    ...
    const delet = async ()=> {
        ...
        try{
            const salvarNome = JSON.stringify("check")
            await AsyncStorage.setItem('@NomeListaSimples2',salvarNome)
        ...
        try{
            ...
            await AsyncStorage.setItem('@ListaSimples2',salvarNome)
            
        }catch(e){
            
        }
        
        props.setListaSimples("");
        props.setNomeListaSimples("check");
        ...
        return(
            <View style={styles.container}>
                ...
                >
                    ...
                    <AntDesign name="checksquareo" size={28} color="black" />
                </TouchableOpacity>
        ...
        return(
            <View style={styles.container}>
                ...
                <View style={styles.BTN}>
                    <TouchableOpacity onPress={()=>props.setPagina("ListaSimples2")} >
                        <Text style={styles.BTNTXT}>{props.Comp}</Text>
                    </TouchableOpacity>
