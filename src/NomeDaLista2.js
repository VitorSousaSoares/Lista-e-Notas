...
export default function App(props) {
    ...
    const Nomear = async ()=> {
        if (Nome ==="") {
            ...
            props.setNomeLista(Nome);
            
            try{
                const salvarNome = JSON.stringify(Nome)
                await AsyncStorage.setItem('@NomeLista2',salvarNome)
    ...
    const delet = async ()=> {
        ...
        try{
            const salvarNome = JSON.stringify("Compras")
            await AsyncStorage.setItem('@NomeLista2',salvarNome)
        ...
        try{
            ...
            await AsyncStorage.setItem('@Lista2',salvarNome)
        ...
        props.setOrsamento("")
        props.setCompras("");
        props.setNomeLista("Compras");
        props.setPagina("Listas");
        
    }
    
    if (props.Comp === "Compras") {
        return(
        ...
        return(
            <View style={styles.container}>
                ...
                <View style={styles.BTN}>
                    <TouchableOpacity onPress={()=>props.setPagina("Compras2")} >
                        <Text style={styles.BTNTXT}>{props.Comp }</Text>
                    </TouchableOpacity>
