...
export default function App(props) {
    ...
    const Nomear = async ()=> {
        if (Nome ==="") {
            ...
            try{
                ...
                await AsyncStorage.setItem('@NomeListaSimples',salvarNome)
                
            }catch(e){
                
            }
            props.setPagina("ListaSimples")
        }
    }
    ...
    const delet = async ()=> {
        ...
        try{
            ...
            await AsyncStorage.setItem('@ListaSimples',salvarNome)
        ...
        return(
            <View style={styles.container}>
                ...
                <View style={styles.BTN}>
                    <TouchableOpacity onPress={()=>props.setPagina("ListaSimples")} >
                        <Text style={styles.BTNTXT}>{props.Comp}</Text>
                    </TouchableOpacity>
